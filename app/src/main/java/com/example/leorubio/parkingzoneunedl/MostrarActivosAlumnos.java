...
public class MostrarActivosAlumnos extends AppCompatActivity {

    private RecyclerView recyclerView;
    private PersonAdapterAlumnos adapter;
    private List<Alumnos> artistList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new PersonAdapterAlumnos(this, artistList);
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            if (dataSnapshot.exists()) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    Alumnos artist = snapshot.getValue(Alumnos.class);
